...
export class Backend implements backendInterface {
    ...
    async appendOutput(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.appendOutput(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearGitHubPAT(): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteTerminalSession(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTerminalSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGitHubPAT(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getGitHubPAT();
                return from_candid_opt_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async loadTerminalSessions(): Promise<Array<TerminalSession>> {
        if (this.processError) {
            try {
    ...
    async saveGitHubPAT(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGitHubPAT(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTerminalSession(arg0: TerminalSession): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTerminalSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCachedData(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCachedData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCommandHistory(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCommandHistory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
